//WebGarden 2025: a Primeira execução deste código deve ser feita com o sensor de umidade de solo em solo úmido. O primeiro teste deve ser feito utilizando o arduino junto com um sendor de umidade apropriado.
